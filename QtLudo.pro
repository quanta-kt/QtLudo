...
include/ValueError.h include/GameScreen.h include/About.h include/SaveGameEngine.h

SOURCES += Pawn.cpp Board.cpp Game.cpp GameWindow.cpp Main.cpp paint_helper.cpp \
Path.cpp Dice.cpp ValueError.cpp GameScreen.cpp About.cpp SaveGameEngine.cpp
